...
public class ArrayListMethods {
    public static void main(String[] args) {
        ...
        arr1.addAll(arr2);
        System.out.println("Dodanie kolekcji arr2");
        ...
        if (arr1.contains(p4)) {
            System.out.println("Arr 1 posiada p4");
        }
        if (arr1.containsAll(arr2)) {
            System.out.println("arr1 ma wszystkie elementy arr2");
        }
        ...
        if (arr1.containsAll(arr2)) {
            ...
            System.out.println("arr1 nie posiada wszystkich arr2 :(((");
        }
        ...
        arr1.removeAll(arr2);
        System.out.println("Po usunięciu arr2 z arr1");
        for (Person p : arr1) {
            System.out.println("p = " + p);
        }
