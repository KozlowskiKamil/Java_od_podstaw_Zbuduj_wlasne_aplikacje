...
public class OrganisationExample {
    public static void main(String[] args) {
        ...
        organisation.addParticipant(new Employee("Adam", "programer"));
        organisation.addParticipant(new Employee("Kasia", "programer"));
        organisation.addParticipant(new Contractor("Daniel", "Tester"));
